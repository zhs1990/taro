...
var _amapWx = require('@/libs/amap-wx');
...
var _App = function (_BaseComponent) {
  ...
  _createClass(_App, [{
    ...
    value: function componentDidMount() {
      var myAmapFun = myAmapFun = new _amapWx2.default.AMapWX({
        key: "d573be98c1efdb518ba4f190bb01fa97"
      });
      myAmapFun.getRegeo({
        success: function success(res) {
          (0, _global.setGlobalData)('Adcode', res[0].regeocodeData.addressComponent.adcode); //全局变量
        }
      });
    }
  }, {
